...
module.exports = class PersistenceConfiguration {
    ...
    static validate(config)
    {
        ...
        if (typeof config.rowInterceptor === "undefined" || config.rowInterceptor instanceof CassandraRowInterceptor === false)
        {
            throw new RangeError("logger has not been defined");
        }
    }
    ...
    static defaults()
    {
        ...
        config.rowInterceptor = new CassandraRowInterceptor();
        return config;
    }
};
