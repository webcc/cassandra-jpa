...
let TimeUuid = driver.types.TimeUuid;
module.exports = class PersistenceUtils {
    ...
    static toTimeUuid(value)
    {
        ...
        {
            if (PersistenceUtils.isImplementationOf(value, TimeUuid) )
            {
                return value;
            }
    ...
    static isImplementationOf(targetObject, target){
        ...
        Object.getOwnPropertyNames(targetPrototype).forEach(function(propName, idx, array){
