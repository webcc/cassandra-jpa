...
module.exports = class BaseEAO {
    constructor(config)
    {
        ...
        this.entityClass = config.baseEntityClass;
        this.table = {
            name: "base",
    ...
    updateRow(row, restrictionCriteria, callback)
    {
        const queryObject = PersistenceUtils.buildUpdateQuery(row, restrictionCriteria, this.table.name,
