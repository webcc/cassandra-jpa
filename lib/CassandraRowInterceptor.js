...
module.exports = class CassandraRowInterceptor {
    constructor()
    {
        this.fieldTypes = new Map();
        this.fieldTypes.set("uuid", CassandraRowInterceptor.toUuid);
        this.fieldTypes.set("timeuuid", CassandraRowInterceptor.toUuid);
        this.fieldTypes.set("text", CassandraRowInterceptor.toText);
        this.fieldTypes.set("varchar", CassandraRowInterceptor.toText);
        this.fieldTypes.set("map<text,bigint>", CassandraRowInterceptor.toMapText);
        this.fieldTypes.set("list<text>", CassandraRowInterceptor.toListText);
        this.fieldTypes.set("list<timeuuid>", CassandraRowInterceptor.toListTimeUuid);
        this.validate();
    }
    ...
    toRow(type, propertyValue, entityClass)
    {
        ...
        {
            throw new RangeError("No Cassandra JPA interceptor found for " + type)
        }
        return row;
    }
    ...
    static toListTimeUuid(propertyValue, entityClass)
    {
        if (Array.isArray(propertyValue))
        {
            ...
            {
                properties.push(CassandraRowInterceptor.toUuid(pro, entityClass));
            });
            return properties;
        }
    }
